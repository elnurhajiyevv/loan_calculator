...
class GetSelectedRateUseCase @Inject constructor(
    private val homeRepository: HomeRepository,
    context: CoroutineContext,
    converter: ErrorConverter,
) : BaseSingleUseCase<Unit, Float>(context, converter) {

    override fun invoke(params: Unit): Float {
        return homeRepository.getLastRate()
    }
}