...
package loan.exchange.currency.notification
...
import loan.exchange.currency.MainActivity
import loan.exchange.currency.R
import loan.exchange.currency.notification.entity.DeepLinkTypes
import loan.exchange.currency.notification.entity.NotificationModel
...
class NotificationHandlerImpl @Inject constructor(@ApplicationContext val context: Context) :
    ...
    private fun getGraphDestination(@DeepLinkTypes.DeepLinkTypesDef deepLink: String?): Int {
        return when (deepLink) {
            DeepLinkTypes.HOME -> R.id.homepageFragment
