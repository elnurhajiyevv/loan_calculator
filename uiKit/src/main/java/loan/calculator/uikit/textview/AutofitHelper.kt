...
class AutofitHelper private constructor(view: AppCompatTextView) {
    // Attributes
    ...
    fun setMinTextSize(unit: Int, size: Float): AutofitHelper {
        val context: Context? = mTextView.context
        var r: Resources = Resources.getSystem()
        if (context != null) {
    ...
    companion object {
         ...
         */
        @JvmOverloads
        fun create(view: AppCompatTextView, attrs: AttributeSet? = null, defStyle: Int = 0): AutofitHelper {
         ...
         */
        private fun autofit(
            view: AppCompatTextView, paint: TextPaint, minTextSize: Float, maxTextSize: Float,
        ...
        private fun getMaxLines(view: AppCompatTextView): Int {
