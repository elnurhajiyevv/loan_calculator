...
import loan.exchange.core.dialog.CustomProgressDialog
import loan.exchange.core.extension.deeplinkNavigate
...
abstract class BaseFragment<State, Effect, ViewModel : BaseViewModel<State, Effect>, B : ViewBinding> :
    ...
    override fun onCreateView(
        ...
        binding.root.findViewWithTag<MaterialToolbar>("toolbar")?.let {
            ...
            setToolbarCustomBackButton(R.drawable.ic_arrow_left)
        }
        return binding.root
    }
